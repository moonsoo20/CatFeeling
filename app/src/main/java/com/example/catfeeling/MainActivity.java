...
import com.example.catfeeling.ml.Model;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextBtn.setOnClickListener(new View.OnClickListener() { //다음 액티비티 넘기기
            public void onClick(View v) {
            Context c = v.getContext();
            Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://jade-hummingbird-d7ba42.netlify.app/"));
    ...
    public void classifyImage(Bitmap image){  //분류함수
        try {
            ...
            String[] classes={"겁먹음","기분좋음","예민+짜증","평온"};
